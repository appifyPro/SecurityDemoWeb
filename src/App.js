  ...
  return (
    ...
    <div className="container">
      ...
      <div className="row g-4 align-items-center">
			<div className="col-lg-6">
				<div className="row g-xl-5">
					<div className="col-md-6">
						<div className="card card-body bg-light p-4 mt-5">
			...
			<div className="col-lg-6 ps-xl-7">
				...
				<a className="btn btn-dark me-3 mb-0" href="services.html">Explore services!</a>
				<a className="icon-link icon-link-hover" href="contact-v2.html">Request a quote<i className="bi bi-arrow-right"></i> </a>
